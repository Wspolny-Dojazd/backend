...
/// </summary>
/// <param name="shapeRepository">Repository for shape data.</param>
    ...
    IShapeRepository shapeRepository) : IPathAssembler
{
        ...
        SegmentType segmentType)
    {
        ...
        return segmentType switch
        {
            ...
            SegmentType.Walk => this.BuildWalkSegmentDto(segmentsGroup, stopsOrdered, stopLookup),
    ...
    private SegmentDtoBase BuildWalkSegmentDto(
        List<PathSegment> segmentsGroup,
        List<string> stopsOrdered,
        IReadOnlyDictionary<string, Stop> stopLookup)
    {
